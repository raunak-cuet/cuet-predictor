            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-4">
              <nav className="card flex items-center justify-between px-4 sm:px-6 py-2.5 sm:py-4">
                ...
                <div className="flex items-center gap-2 sm:gap-3 text-sm">
                  ...
                  <a href="/how-to-use" className="inline-flex items-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 border border-indigo-200 transition font-medium">
